...
public class LogOutActivity extends AppCompatActivity implements View.OnClickListener,GoogleApiClient.OnConnectionFailedListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String personName=getIntent().getExtras().getString("display_name");
...
//}
    ...
    {Toast.makeText(this,"Trying to SignOut",Toast.LENGTH_SHORT).show();
    ...
    public void onConnectionFailed(@NonNull ConnectionResult connectionResult) {
        ...
        Toast.makeText(LogOutActivity.this, "" + connectionResult, Toast.LENGTH_SHORT).show();
    }
    @Override
    public boolean onCreateOptionsMenu(Menu menu) {
